             ...
             <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Study Notes
                            <a href="<?= site_url('forum/create_note') ?>" class="btn btn-primary btn-sm float-end">Add</a>
                        </h5>
                    </div>
                        ...
                        <table class="table table-bordered" id="mydatatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $note['filename'] ?></td>
                                    <td><a href="<?= base_url('forum/note/download?id='.$note['id']); ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-download-alt">Download</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
